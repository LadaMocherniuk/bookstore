...
<form method="POST" action="{{route('admin.products.store')}}">@csrf
  <div class="-mx-3 md:flex mb-6">
    <div class="md:w-1/2 px-3 mb-6 md:mb-0">
      ...
      <input class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-red rounded py-3 px-4 mb-3" id="grid-name" type="text" placeholder="Product name" name="name">
    ...
    <div class="md:w-1/2 px-3">
      ...
      <input class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4" id="grid-price" type="text" placeholder="Product price" name="price">
    </div>
  </div>
  <div class="-mx-3 md:flex mb-6">
    <div class="md:w-full px-3">
      ...
      <textarea class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4 mb-3" id="grid-description" type="password" name="description">
      </textarea>
    </div>
  </div>
  ...
  <div class="flex p-1">
    <button role="submit" class="p-3 bg-blue-500 text-white hover:bg-blue-400">Add New Product</button> 
  </div>
  </form>
</div>
